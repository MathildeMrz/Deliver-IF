...
public abstract class TemplateTSP2 implements TSP {
	 ...
	 */
	protected abstract Iterator<Integer> iterator(Integer currentVertex, Collection<Integer> unvisited, Graph g, double cost [][]);
	...
	private void branchAndBound(int currentVertex, Collection<Integer> unvisited, 
	    ...
	    } else if (currentCost+bound(currentVertex,unvisited,cost,currentCost,timeLapsStart,timeLapsEnd) < bestSolCost){
